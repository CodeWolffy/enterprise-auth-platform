    ...
    children: [
      {
        ...
        path: 'tenants',
        component: () => import('#/views/upms/tenant/index.vue'),
        meta: { title: '租户管理' },
      },
      {
        name: 'platform-tenant-catalog',
        path: 'tenant-catalog',
        component: () => import('#/views/system/tenant-catalog/index.vue'),
        meta: { title: '租户套餐' },
      },
      {
        name: 'platform-files',
        path: 'files',
        component: () => import('#/views/upms/file/index.vue'),
        meta: { title: '文件管理' },
      },
      {
        name: 'platform-dicts',
        path: 'dicts',
        component: () => import('#/views/upms/dict/index.vue'),
        meta: { title: '字典管理' },
      },
      {
        name: 'platform-configs',
        path: 'configs',
        component: () => import('#/views/upms/config/index.vue'),
        meta: { title: '参数管理' },
      },
      {
      ...
      },
      {
        ...
        path: 'notices',
        component: () => import('#/views/upms/notice/index.vue'),
        meta: { title: '公告管理' },
      },
      {
        name: 'platform-categories',
        path: 'categories',
        component: () => import('#/views/upms/category/index.vue'),
        meta: { title: '分类配置' },
      },
      {
