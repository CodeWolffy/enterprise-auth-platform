...
export function defaultSnapshot(): MockPermissionSnapshot {
  return {
    ...
    grants: [
      ...
      'upms:sysdept:page',
      'upms:systenant:page',
      'upms:tenantcatalog:page',
      'upms:operationlog:page',
      'upms:loginlog:page',
      'upms:system:page',
      'upms:session:page',
      'upms:sysmenu:page',
    ...
    menus: [
      ...
      },
      {
        ...
        icon: 'Document',
        children: [
          { id: 26, code: 'login-logs', title: '登录日志', path: '/system/logs/login', component: 'LoginLogView', routeKey: 'login-logs' },
