...
<span class="eyebrow">分类</span>
        ...
        <el-button v-permission="'upms:syscategory:add'" type="primary" @click="openDialog()">新增分类</el-button>
      </div>
      ...
      >
        ...
        >
          <template #default="{ row }">
            ...
            <el-button v-permission="'upms:syscategory:edit'" link type="primary" @click="openDialog(row)">编辑</el-button>
            <el-button v-permission="'upms:syscategory:del'" link type="danger" @click="removeRow(row)">删除</el-button>
          </template>
        </el-table-column>
        <template #empty>
    ...
    <el-dialog v-model="visible" :title="editingCode ? '编辑分类' : '新增分类'" width="560px">
      ...
      <template #footer>
        ...
        <el-button v-permission="['upms:syscategory:add', 'upms:syscategory:edit']" type="primary" @click="submit">保存</el-button>
      </template>
    </el-dialog>
