...
(1, 'platform', '平台租户', 1, 1, UTC_TIMESTAMP(), '2099-12-31 23:59:59', 'DEFAULT', '平台管理员', '13800000000', 'admin@example.com', '系统内置平台租户', 'system', 'system', 0);
...
(1, 'platform', 1, 'admin', '$2b$12$JreITuCCL.pquUQc1Xxve.GoIyhIh7.iyLu776/Mk4qkRY12YD206', 1, 1, 0, '平台管理员', '13800000000', 'admin@example.com', 'system', 'system', 0, UTC_TIMESTAMP());
...
(100, NULL, '运行总览', NULL, '/dashboard', 'dashboard', 10, '0', NULL, 'Monitor', 0, 'base', '0', 'system', 'system', 0),
...
(200, NULL, '系统管理', NULL, NULL, 'system', 20, '0', NULL, 'Setting', 0, 'system', '0', 'system', 'system', 0),
(210, 200, '用户管理', NULL, '/system/users', 'users', 10, '0', NULL, 'Avatar', 0, 'system', '0', 'system', 'system', 0),
...
(220, 200, '角色管理', NULL, '/system/roles', 'roles', 20, '0', NULL, 'Connection', 0, 'system', '0', 'system', 'system', 0),
...
(230, 200, '部门管理', NULL, '/system/depts', 'depts', 30, '0', NULL, 'OfficeBuilding', 0, 'system', '0', 'system', 'system', 0),
...
(240, 200, '在线用户', NULL, '/system/online-users', 'online-users', 40, '0', NULL, 'Monitor', 0, 'system', '0', 'system', 'system', 0),
...
(250, 200, '菜单管理', NULL, '/system/menus', 'menus', 50, '0', NULL, 'Tickets', 0, 'system', '0', 'system', 'system', 0),
...
(260, 200, '系统设置', NULL, '/system/settings', 'settings', 60, '0', NULL, 'Setting', 0, 'system', '0', 'system', 'system', 0),
...
(270, 200, '操作日志', NULL, '/system/logs/operation', 'operation-logs', 70, '0', NULL, 'Document', 0, 'system', '0', 'system', 'system', 0),
...
(280, 200, '登录日志', NULL, '/system/logs/login', 'login-logs', 80, '0', NULL, 'Document', 0, 'system', '0', 'system', 'system', 0),
...
(300, NULL, '平台管理', NULL, NULL, 'platform-management', 30, '0', NULL, 'Platform', 0, 'platform', '0', 'system', 'system', 0),
(310, 300, '租户管理', NULL, '/platform/tenants', 'tenants', 10, '0', NULL, 'Flag', 0, 'platform', '0', 'system', 'system', 0),
...
(320, 300, '租户套餐', NULL, '/platform/tenant-catalog', 'tenant-catalog', 20, '0', NULL, 'Tickets', 0, 'platform', '0', 'system', 'system', 0),
...
(330, 300, '文件管理', NULL, '/platform/files', 'files', 30, '0', NULL, 'FolderOpened', 0, 'platform', '0', 'system', 'system', 0),
...
(340, 300, '字典管理', NULL, '/platform/dicts', 'dicts', 40, '0', NULL, 'Tickets', 0, 'system', '0', 'system', 'system', 0),
...
(350, 300, '参数管理', NULL, '/platform/configs', 'configs', 50, '0', NULL, 'Setting', 0, 'system', '0', 'system', 'system', 0),
...
(360, 300, '邮件配置', NULL, '/platform/mail-channel', 'mail-channel', 60, '0', NULL, 'Message', 0, 'platform', '0', 'system', 'system', 0),
...
(370, 300, '公告管理', NULL, '/platform/notices', 'notices', 70, '0', NULL, 'Tickets', 0, 'platform', '0', 'system', 'system', 0),
...
(380, 300, '分类配置', NULL, '/platform/categories', 'categories', 80, '0', NULL, 'Tickets', 0, 'platform', '0', 'system', 'system', 0),
...
(390, 300, '代码生成', NULL, '/platform/codegen', 'codegen', 90, '0', NULL, 'Document', 0, 'dev', '0', 'system', 'system', 0),
...
(400, NULL, '工作流', NULL, NULL, 'workflow', 40, '0', NULL, 'Connection', 0, 'workflow', '0', 'system', 'system', 0),
(410, 400, '流程设计器', NULL, '/platform/workflow/designer', 'workflow-designer', 10, '0', NULL, 'Connection', 0, 'workflow', '0', 'system', 'system', 0),
(411, 410, '流程设计器入口', 'upms:workflowdesigner:page', NULL, NULL, 1, '1', NULL, NULL, 0, 'workflow', '0', 'system', 'system', 0),
(420, 400, '流程定义', NULL, '/platform/workflow/definitions', 'workflow-definitions', 20, '0', NULL, 'Tickets', 0, 'workflow', '0', 'system', 'system', 0),
...
(430, 400, '我的发起', NULL, '/platform/workflow/my-instances', 'workflow-my-instances', 30, '0', NULL, 'Document', 0, 'workflow', '0', 'system', 'system', 0),
...
(440, 400, '我的待办', NULL, '/platform/workflow/todo', 'workflow-todo', 40, '0', NULL, 'Tickets', 0, 'workflow', '0', 'system', 'system', 0),
...
(450, 400, '我的已办', NULL, '/platform/workflow/done', 'workflow-done', 50, '0', NULL, 'Document', 0, 'workflow', '0', 'system', 'system', 0),
...
INSERT INTO `sys_role_menu` (`tenant_id`, `role_id`, `menu_id`, `create_time`) SELECT 'platform', 1, `id`, UTC_TIMESTAMP() FROM `sys_menu` WHERE `del_flag` = '0';
