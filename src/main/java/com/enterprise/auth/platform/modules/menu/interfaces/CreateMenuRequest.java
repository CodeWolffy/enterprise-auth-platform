...
public record CreateMenuRequest(
        ...
        @Schema(description = "菜单类型", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull MenuType type,
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED) @NotBlank String name,
