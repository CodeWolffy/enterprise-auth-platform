...
import com.enterprise.auth.platform.modules.audit.interfaces.AuditExportPolicyRequest;
...
import com.enterprise.auth.platform.modules.audit.interfaces.AuditPage;
import com.enterprise.auth.platform.modules.audit.interfaces.AuditQuery;
import com.enterprise.auth.platform.modules.audit.application.AuditExportTaskService;
...
public class AuditController {
    ...
    @GetMapping("/events")
    @SaCheckPermission(PermissionCodes.AUDIT_PAGE)
    ...
    @SaCheckPermission(PermissionCodes.AUDIT_EXPORT)
    ...
    @SaCheckPermission(PermissionCodes.AUDIT_GET)
    ...
    @SaCheckPermission(PermissionCodes.AUDIT_EDIT)
    ...
    @SaCheckPermission(PermissionCodes.AUDIT_DOWNLOAD)
    ...
    @SaCheckPermission(PermissionCodes.AUDIT_DEL)
